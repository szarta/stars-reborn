...
def build_tutorial_universe():
    ...
    p.gravity_level = 5.84
    p.temperature_level = -36
    ...
    p.gravity_level = 0.13
    p.temperature_level = 172
    p.radiation_level = 39
    tutorial_universe.planets[p.id] = p
    ...
    p.gravity_level = 0.17
    p.temperature_level = 68
    p.radiation_level = 86
    tutorial_universe.planets[p.id] = p
    ...
    p.gravity_level = 3.68
    p.temperature_level = 104
    p.radiation_level = 98
    tutorial_universe.planets[p.id] = p
    ...
    p.gravity_level = 1.76
    p.temperature_level = -120
    p.radiation_level = 44
    tutorial_universe.planets[p.id] = p
    ...
    p.ironium_concentration = 25
    p.gravity_level = 1.0
    p.temperature_level = 0
    p.radiation_level = 50
    ...
    p.gravity_level = 1.08
    p.temperature_level = 160
    p.radiation_level = 62
    tutorial_universe.planets[p.id] = p
    ...
    p.gravity_level = 1.68
    p.temperature_level = 72
    p.radiation_level = 9
    tutorial_universe.planets[p.id] = p
    ...
    p.gravity_level = 3.20
    p.temperature_level = 28
    p.radiation_level = 98
    tutorial_universe.planets[p.id] = p
    ...
    p.gravity_level = 0.60
    p.temperature_level = 104
    p.radiation_level = 13
    tutorial_universe.planets[p.id] = p
    ...
    p.gravity_level = 0.51
    p.temperature_level = -60
    p.radiation_level = 13
    tutorial_universe.planets[p.id] = p
    ...
    p.gravity_level = 3.44
    p.temperature_level = 16
    p.radiation_level = 92
    tutorial_universe.planets[p.id] = p
    ...
    p.gravity_level = 1.32
    p.temperature_level = -60
    p.radiation_level = 65
    tutorial_universe.planets[p.id] = p
    ...
    p.gravity_level = 0.56
    p.temperature_level = -160
    p.radiation_level = 82
    tutorial_universe.planets[p.id] = p
    ...
    p.gravity_level = 1.44
    p.temperature_level = 112
    p.radiation_level = 27
    tutorial_universe.planets[p.id] = p
    ...
    p.gravity_level = 1.56
    p.temperature_level = 20
    p.radiation_level = 74
    tutorial_universe.planets[p.id] = p
    ...
    p.gravity_level = 0.33
    p.temperature_level = -124
    p.radiation_level = 19
    tutorial_universe.planets[p.id] = p
    ...
    p.gravity_level = 1.56
    p.temperature_level = -84
    p.radiation_level = 48
    tutorial_universe.planets[p.id] = p
    ...
    p.germanium_concentration = 62
    p.gravity_level = 1.44
    p.temperature_level = 136
    p.radiation_level = 34
    tutorial_universe.planets[p.id] = p
    ...
    p.gravity_level = 0.24
    p.temperature_level = -96
    p.radiation_level = 79
    tutorial_universe.planets[p.id] = p
    ...
    p.gravity_level = 0.21
    p.temperature_level = 48
    p.radiation_level = 32
    tutorial_universe.planets[p.id] = p
    ...
    p.gravity_level = 2.00
    p.temperature_level = -116
    p.radiation_level = 59
    tutorial_universe.planets[p.id] = p
    ...
    p.boranium_concentration = 70
    p.germanium_concentration = 84
    p.gravity_level = 0.67
    p.temperature_level = -44
    p.radiation_level = 46
    tutorial_universe.planets[p.id] = p
...
def build_computer_races():
    ...
    # TODO: build the rest of the CPU AI races
